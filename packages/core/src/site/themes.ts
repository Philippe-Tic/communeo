...
export const THEMES = [
  ...
  { id: 'journal', name: 'Journal', description: 'Le journal de la commune : navigation en barre latérale, une de journal, rubriques en colonnes.', available: true, menus: { main: true, footer: true }, homeSections: HOMEPAGE_SECTION_IDS },
  { id: 'bourg', name: 'Bourg', description: 'Chaleureux et pratique : mairie, alertes, collectes et météo toujours à portée de main.', available: true, menus: { main: true, footer: true }, homeSections: HOMEPAGE_SECTION_IDS },
