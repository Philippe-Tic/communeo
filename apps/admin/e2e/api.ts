  ...
  const site = {
    ...
    homepage: {
      hero: {
        ...
        subtitle: '3 240 habitants au bord de la Loire.',
        image: null,
        primary_label: 'Vos démarches',
      ...
      quick_links: {
        ...
        items: [
          {
            label: 'État civil',
            url: '/location-salle-des-fetes',
            description: 'Actes, mariage, PACS',
            icon: 'identity',
          },
      ...
      agenda: { enabled: true, count: 4 },
      associations: { enabled: false, count: 3 },
      mayor_word: { enabled: false, title: null, body: null, photo: null, signature_name: null, signature_role: null },
      key_figures: { enabled: false, items: [] },
      partners: { enabled: false, items: [] },
      free_content: { enabled: false, title: null, body: null },
      practical_info: { enabled: true },
      weather: { enabled: false },
      waste_collection: { enabled: true },
      disruptions: { enabled: true },
      canteen: { enabled: false },
