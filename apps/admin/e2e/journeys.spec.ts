 ...
 * - B : changer de thème avec aperçu (voir aussi appearance.spec.ts ; seuls Institutionnel et Moderne sont
 *   construits, le parcours part donc d'une commune en Journal).
 */
